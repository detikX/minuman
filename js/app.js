...
$(".datax .questionx p, .datax .questionx li, .datax .questionx h3, .datax .questionx small, .datax .questionx canvas").attr({ "data-wow-delay": "0.5s" }).addClass('wow animate__animated animate__fadeIn')
